...
sync_platform_uploads() {
    ...
    cp $BUILDER_DIR/platform-uploads/tomcat-app.service /etc/systemd/system/
    cp -r $BUILDER_DIR/platform-uploads/elasticbeanstalk /opt/
    cp -r $BUILDER_DIR/platform-uploads/TomcatPlatform /opt/
    cp -r $BUILDER_DIR/platform-uploads/etc/TomcatPlatform /etc/
}
